...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("KianDesk".to_owned());
...
impl Config {
    ...
    pub fn get_rendezvous_server() -> String {
        // Server is fixed at compile time (see RENDEZVOUS_SERVERS); ignore any
        // user/runtime override so the client always connects to our server.
    ...
    pub fn get_rendezvous_servers() -> Vec<String> {
        // Server is fixed at compile time; ignore any user/runtime override.
